...
public:
     ...
     */
    std::pair<std::vector<uint8_t>, Node> PrepareOnion(const std::vector<Node>& nodes, const std::vector<uint8_t>& originalData);
     ...
     *
     * @return const std::vector<unsigned char>& The public key.
     */
